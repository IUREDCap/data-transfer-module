...
Feature: Basic Data Import
  ...
  As a user
  I need to be able to specify and run data imports between non-longitudinal projects
  ...
  Scenario: Transfer data between non-longitudinal projects
    ...
    And I delete configuration "behat-import-basic-test" if it exists
    Then I should not see "behat-import-basic-test"
    And I should not see "REDCap crashed"

    # Create data transfer configuration
    When I add configuration "behat-import-basic-test"
    And I follow configuration "behat-import-basic-test"
    And I enable import from local project "Data Transfer - Basic Source Project"
    And I check transfer files
    And I add field mapping "" "ALL" "ALL" to "" "MATCHING" "EQUIVALENT"
    Then I should see "behat-import-basic-test"
    But I should not see "REDCap crashed"
