...
Feature: Data Transfer
  ...
  Scenario: Transfer only file data data
    ...
    And I delete configuration "behat-export-repeating-files-api-test" if it exists
    Then I should not see "behat-export-repeating-files-api-test"
    And I should not see "REDCap crashed"

    # Add the file data transfer configuration
    When I add configuration "behat-export-repeating-files-api-test"
    And I follow configuration "behat-export-repeating-files-api-test"
    And I enable export to API project with URL property "redcap" "api_url" and token property "project_repeating_events_destination" "api_token"
    ...
    Then I should see "behat-export-repeating-files-api-test"
    But I should not see "REDCap crashed"
