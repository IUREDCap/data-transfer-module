...
Feature: Data Transfer
  ...
  Scenario: Transfer data
    ...
    # And I should see "home-visit-1001-1-patient-notes.txt"
    # And I should see "home-visit-1001-1-researcher-notes.txt"
    # And I should see "home-visit-1001-2-patient-notes.txt"
