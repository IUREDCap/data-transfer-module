...
Feature: Data Transfer
  ...
  Scenario: Transfer data
    ...
    When I go to Data Transfer for project "Data Transfer - Repeating Events Source Project - Secondary ID"
    And I delete configuration "behat-export-repeating-secondary-test" if it exists
    Then I should not see "behat-export-repeating-secondary-test"
    And I should not see "REDCap crashed"

    When I add configuration "behat-export-repeating-secondary-test"
    And I follow configuration "behat-export-repeating-secondary-test"
    ...
    Then I should see "behat-export-repeating-secondary-test"
    But I should not see "REDCap crashed"
