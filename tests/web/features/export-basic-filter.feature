...
Feature: Data Transfer
  ...
  Scenario: Transfer data
    ...
    And I delete configuration "behat-export-basic-filter-test" if it exists
    Then I should not see "behat-export-basic-filter-test"
    And I should not see "REDCap crashed"

    When I add configuration "behat-export-basic-filter-test"
    And I follow configuration "behat-export-basic-filter-test"
    ...
    And I set source project filter logic to "[record_id] < 1021"
    And I add field mapping "" "ALL" "ALL" to "" "MATCHING" "EQUIVALENT"
    Then I should see "behat-export-basic-filter-test"
    But I should not see "REDCap crashed"
    ...
    And the project data should match test data file "basic-filter-dag.csv"
    But I should not see "REDCap crashed"
    When I go to project home for project "Data Transfer - Basic Destination Project"
    Then I should see table row ("Records in project, 20")
